...
import { SongActions, type SongUsageInfo } from "./song-actions";
...
export function SongRow({ song, usage, ...actions }: SongRowProps) {
  return (
    <TableRow>
      ...
      <TableCell className="w-14 text-right"><SongActions song={song} usage={usage} {...actions} /></TableCell>
    </TableRow>
  );
}
